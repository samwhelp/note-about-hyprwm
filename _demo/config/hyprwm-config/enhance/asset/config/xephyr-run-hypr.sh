...
__main__ () {
	...
	## /usr/bin/Hypr
	## run Hypr
	#DISPLAY=:100 /usr/bin/Hypr
	##

	##
	## $ grep '^Exec=' /usr/share/xsessions/hyprwm-session.desktop
	## Exec=/usr/share/hyprwm/xsessions/hyprwm-session
	##
	## run hyprwm-session
	DISPLAY=:100 /usr/share/hyprwm/xsessions/hyprwm-session
